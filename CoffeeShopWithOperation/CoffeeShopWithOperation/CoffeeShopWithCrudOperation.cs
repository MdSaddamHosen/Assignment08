...
namespace CoffeeShopWithOperation
{
    public partial class CoffeeShopWithCrudOperation : Form
    {
        ...
        private void addCustomerButton_Click(object sender, EventArgs e)
        {
            ...
            {
                //declare 
                _customer.Name = nameCustomerTextBox.Text;
                _customer.Address = addressCustomerTextBox.Text;
                _customer.Contract = contractCustomerTextBox.Text;
                //nameCustomerTextBox.Text
                if (_CustoemerManager.isexitename(_customer.Name))
                ...
                bool isadded = _CustoemerManager.addcustomer(_customer);
                if (isadded)
                {
        ...
        private void deleteCustomerButton_Click(object sender, EventArgs e)
        {
            ...
            _customer.ID = Convert.ToInt32(idCustomerTextBox.Text);

            if (_CustoemerManager.delete(_customer))
            {
        ...
        private void updaCustomerButton_Click(object sender, EventArgs e)
        {
            ...
            if (_CustoemerManager.update(_customer))
            {
        ...
        private void searchCustomerButton_Click(object sender, EventArgs e)
        {
            ...
            showCustomerDataGridView.DataSource = _CustoemerManager.search(_customer);
        }

        private void CoffeeShopWithCrudOperation_Load(object sender, EventArgs e)
        {
