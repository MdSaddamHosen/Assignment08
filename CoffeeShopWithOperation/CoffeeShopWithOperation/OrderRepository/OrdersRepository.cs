    ...
    public class OrdersRepository
    {
        ...
        public bool addorder(OrderCustomer orderCustomer)
        {
            ...
            try
            {
                ...
                string itemsqurey = @" INSERT INTO  Ordercustomer (Name,Item,Quantity,TotalPrice) VALUES('" + orderCustomer.Name + "','" + orderCustomer.Item+ "'," + orderCustomer.Quantity + ","+orderCustomer.TotalPrice+")";
        ...
        public bool update(OrderCustomer orderCustomer)
        {
            try
            {
                ...
                string sqlvalues = @"UPDATE Ordercustomer SET Name='" + orderCustomer.Name + "',Item='" + orderCustomer.Item + "',Quantity=" + orderCustomer.Quantity + ",TotalPrice="+orderCustomer.TotalPrice+" WHERE ID=" + orderCustomer.ID + "";
                SqlCommand sqlCommand = new SqlCommand(sqlvalues, sqlConnection);
                sqlConnection.Open();
...

        {
            try
            {
                ...
                string sqlvalues = @"DELETE FROM Ordercustomer WHERE ID=" + orderCustomer.ID + "";
                SqlCommand sqlCommand = new SqlCommand(sqlvalues, sqlConnection);
                sqlConnection.Open();
                int isexcuted = sqlCommand.ExecuteNonQuery();
                if (isexcuted > 0)
        ...
        public DataTable search(OrderCustomer orderCustomer)
        {
            ...
            string sqlvalues = @"select*from  Ordercustomer where Name='" + orderCustomer.Name + "'";
            SqlCommand sqlCommand = new SqlCommand(sqlvalues, sqlConnection);
